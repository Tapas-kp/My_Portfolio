  ...
  return (
    ...
    <div className='home' id='home'>
      ...
      <div id='left-home'>
        ...
        <IoLogoLinkedin onClick={()=> handleLinkedin("https://www.linkedin.com/in/tapas-kumar-palai-1a343a281/")} style={{height:"40px",width:"50px"}} />
          </div>
          <div id='gitu'>

        <FaGithubSquare   onClick={()=>{handlegit("https://github.com/Tapas-kp")}} style={{height:"40px",width:"50px"}} />
          </div>
          <div id='emu'>
